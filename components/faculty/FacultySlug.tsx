    ...
    return (
        <section className="py-10">
            <div className="w-full max-w-full min-[700px]:max-w-[80%] lg:max-w-[70%] xl:max-w-[60%] mx-auto px-4 min-[700px]:px-6 lg:px-8 xl:px-12">
                <div className="grid grid-cols-1 md:grid-cols-1 gap-8 lg:gap-16 items-start">
                    {/* Image Left */}
                    ...
                    <div className='flex'>
                        ...
                        <div className='w-[55%] flex flex-col space-y-10'>
                            <div>
                                <h2 className="text-lg md:text-2xl font-trade-gothic-bold text-booth-dark-gray uppercase tracking-wider mb-2">
                                    Academic Area
                                </h2>
                    ...
                    <div className="flex flex-col pt-4  pb-12">
                        ...
                        <div className="space-y-10">
                            ...
                            {faculty.accolades && (
                                <div className="pt-8 border-t border-gray-200">
                                    <div className="w-16 h-0.5 bg-booth-maroon mb-3"></div>
                                    <h2 className="text-lg md:text-2xl font-trade-gothic-bold text-booth-dark-gray uppercase tracking-wider mb-6">
