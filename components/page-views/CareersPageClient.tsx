  ...
  return (
    <main className="min-h-screen">
      ...
      <HeroSection
        ...
        description1={
          <>
            <strong>Join a community committed to rigorous teaching and applied learning.</strong>
          </>
        }
        description2={
          <>
            RVS CAS MBA seeks to engage faculty and professional staff who are committed to advancing our mission: to deliver academically rigorous, industry-aligned management education and to prepare students for thoughtful, analytical, and responsible professional careers.
          </>
        }
        description3=""
