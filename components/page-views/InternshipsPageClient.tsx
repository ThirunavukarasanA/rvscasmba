  ...
  return (
    <main className="min-h-screen">
      ...
      <HeroSection
        ...
        description1={
          <>
            <strong>Experience Before Employment. Learning Before Leadership.</strong>
          </>
        }
        description2={
          <>
            Internships at RVS CAS MBA are an integral part of the curriculum across all specializations. They are structured engagements designed to help students apply classroom learning in real organizational environments.
          </>
        }
        description3=""
