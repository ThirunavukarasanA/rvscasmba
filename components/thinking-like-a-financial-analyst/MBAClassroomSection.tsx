      ...
      <div className="w-full max-w-full min-[700px]:max-w-[60%] mx-auto px-4 min-[700px]:px-6 lg:px-8 xl:px-12">
        ...
        <div className="bg-booth-teal -mx-4 min-[700px]:-mx-6 lg:-mx-8 xl:-mx-12 px-4 min-[700px]:px-6 lg:px-8 xl:px-12 py-10 md:py-12">
          <h3 className="text-2xl md:text-3xl font-trade-gothic-bold text-white mb-4">
            Enquire About the MBA in Global Finance & Corporate Analyst Course
          </h3>
          <p className="text-white font-trade-gothic-light text-base md:text-lg mb-6">
            This is how Dr. Senthil teaches at RVS CAS MBA. If this way of thinking resonates with you, explore the full MBA in Global Finance & Corporate Analyst program.
          </p>
          ...
          >
            Enquire About MBA in Global Finance & Corporate Analyst
          </Link>
        </div>
      </div>
    </section>
