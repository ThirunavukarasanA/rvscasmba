    ...
    <footer className="bg-booth-bg-gray">
      ...
      <div className="bg-gray-100 py-6">
        <div className="w-full max-w-full min-[700px]:max-w-[60%] mx-auto px-4 min-[700px]:px-6 lg:px-8 xl:px-12">
          <p className="text-xs text-booth-light-gray font-trade-gothic-light">
            RVS CAS MBA is recognized by AICTE and affiliated with Bharathiar University. 
            All programs are designed to meet industry standards and prepare students for 
            successful careers in management and technology.
          </p>
        </div>
      </div>
      ...
      <div className="w-full max-w-full min-[700px]:max-w-[60%] mx-auto px-4 min-[700px]:px-6 lg:px-8 xl:px-12 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          {/* Column 2: Explore */}
          <div>
            <h3 className="font-trade-gothic-bold text-booth-maroon mb-3 md:mb-4">Explore</h3>
            <ul className="flex flex-wrap gap-3 md:gap-4 md:flex-col md:space-y-2 md:gap-0">
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">About RVS CAS</a></li>
              <li><a href="/" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Programs</a></li>
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Faculty</a></li>
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Research</a></li>
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Alumni</a></li>
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Events</a></li>
            </ul>
          </div>

          {/* Column 3: About */}
          <div>
            <h3 className="font-trade-gothic-bold text-booth-maroon mb-3 md:mb-4">About</h3>
            <ul className="flex flex-wrap gap-3 md:gap-4 md:flex-col md:space-y-2 md:gap-0">
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Industry Connect</a></li>
              <li><a href="/programs/common/admissions" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Admissions</a></li>
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Placements</a></li>
              <li><a href="/programs/common/student-experience" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Campus Life</a></li>
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Careers</a></li>
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Contact Us</a></li>
            </ul>
          </div>

          {/* Column 4: Resources */}
          <div>
            <h3 className="font-trade-gothic-bold text-booth-maroon mb-3 md:mb-4">Resources</h3>
            <ul className="flex flex-wrap gap-3 md:gap-4 md:flex-col md:space-y-2 md:gap-0">
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Campus Facilities</a></li>
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Library</a></li>
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Labs</a></li>
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Sulur Campus</a></li>
              <li><a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light whitespace-nowrap">Coimbatore</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div></div>
          <div>
            <a href="/programs/common/request-information" className="border-2 border-booth-maroon bg-white text-booth-maroon px-4 py-2 font-trade-gothic-bold uppercase hover:bg-booth-maroon hover:text-white transition text-sm w-full inline-block text-center">
              REQUEST INFORMATION
            </a>
          </div>
          <div>
            <a href="/programs/common/how-to-apply" className="border-2 border-booth-maroon bg-white text-booth-maroon px-4 py-2 font-trade-gothic-bold uppercase hover:bg-booth-maroon hover:text-white transition text-sm w-full inline-block text-center">
              APPLY
            </a>
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              {/* Pinterest */}
              <a href="#" className="w-8 h-8 bg-red-700 rounded flex items-center justify-center text-white" aria-label="Pinterest">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-300 pt-6">
          <div className="flex flex-wrap gap-4 items-center text-sm">
            ...
            <a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light">Privacy Policy</a>
            <a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light">Terms & Conditions</a>
            <a href="#" className="text-booth-dark-gray hover:text-booth-maroon font-trade-gothic-light inline-flex items-center gap-1">
              NAAC / AICTE
              <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
