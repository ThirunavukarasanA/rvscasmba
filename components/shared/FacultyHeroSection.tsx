...
export default function FacultyHeroSection({ title, strong, pageName,
    description1, description2, description3, image,
    button1, button2, button1Link,
    button2Link, params, faculty }:
    {
        pageName: string,
        title: string,
        strong?: string,
    ...
    return (
        <section className="relative min-h-[100vh] md:min-h-[75vh]">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between pt-24 pb-16">
                ...
                <div className={containerWidthClass}>
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-16 items-start mt-16 md:mt-24 lg:mt-48 xl:mt-72">
                        ...
                        {/* </div> */}
                        <div className="md:col-span-7 flex flex-col pt-4 md:pt-16 pb-12">
