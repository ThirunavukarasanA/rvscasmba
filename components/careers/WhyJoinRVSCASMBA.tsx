export default function WhyJoinRVSCASMBA() {
    return (
        <section className="py-8 md:py-20 bg-white">
            <div className="w-full max-w-full min-[700px]:max-w-[60%] mx-auto px-4 min-[700px]:px-6 lg:px-8 xl:px-12">
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-lg md:text-xl text-booth-dark-gray font-trade-gothic-light">
                        Faculty and professional staff work with motivated learners in an environment that values intellectual discipline and practical relevance. You will contribute to a curriculum that connects theory with real-world application, mentor students in analytical thinking and decision-making, and collaborate with colleagues who bring both academic and industry experience. We believe education should shape how managers think — not just what they know — and our faculty are central to that mission.
                    </p>
