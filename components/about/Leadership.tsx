                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-16 items-center">
                    ...
                    <div className="order-2 md:order-1 md:col-span-5 flex flex-col justify-center">
                        ...
                        <div className="group inline-block">
                            ...
                            <Link href="/faculty/dr-k-senthil-ganesh" className="text-base flex items-center gap-3 underline md:text-lg text-booth-maroon font-trade-gothic-bold mb-4">Read More <BsArrowRight className="w-[18px] h-[18px]" strokeWidth={0.5} /></Link>
