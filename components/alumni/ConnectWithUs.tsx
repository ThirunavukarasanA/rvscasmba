        ...
        <section className="py-8 md:py-20 bg-booth-bg-gray">
            <div className="w-full max-w-full min-[700px]:max-w-[60%] mx-auto px-4 min-[700px]:px-6 lg:px-8 xl:px-12">
                <div className="mb-6 md:mb-12">
                    ...
                    <p className='text-xl md:text-2xl text-booth-dark-gray font-trade-gothic-light mb-6'><strong>Join the Alumni Network</strong></p>
                    <p className='text-xl md:text-2xl text-booth-dark-gray font-trade-gothic-light mb-6'><strong>Share Your Story</strong></p>
                </div>
