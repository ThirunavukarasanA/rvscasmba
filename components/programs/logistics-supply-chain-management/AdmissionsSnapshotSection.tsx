...
function DownloadBrochureButton() {
  ...
  const courseName = "MBA in Logistics & Supply Chain Management";
  const brochurePath = "/pdfs/MBA in Logistics & Supply Chain Management.pdf";
  return (
    <>
      <button
        type="button"
      ...
      <div className="w-full max-w-full min-[700px]:max-w-[70%] mx-auto px-4 min-[700px]:px-6 lg:px-8 xl:px-12">
        ...
        <div className="space-y-6">
          <p className="text-lg md:text-xl text-booth-dark-gray font-trade-gothic-light">
            ...
            Seats are limited to maintain quality and a cohort serious about
            supply chain as a strategic career discipline.
          </p>
          <div>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              href="https://admissions.rvscas.ac.in?id=6246952974b78f49cd6c2bb8&leadform=RVSCAS_MBA_Website_Logistics_Supply_Chain_Admissions_Snapshot_Section"
              className="border-2 border-booth-maroon bg-white text-booth-maroon px-6 py-3 md:px-8 md:py-4 font-trade-gothic-bold uppercase hover:bg-booth-maroon hover:text-white transition text-sm md:text-base"
            >
              Apply Now
            </Link>
