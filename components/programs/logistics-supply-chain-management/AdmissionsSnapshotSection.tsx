      ...
      <div className="w-full max-w-full min-[700px]:max-w-[70%] mx-auto px-4 min-[700px]:px-6 lg:px-8 xl:px-12">
        ...
        <div className="space-y-6">
          <p className="text-lg md:text-xl text-booth-dark-gray font-trade-gothic-light">
            <strong className="font-trade-gothic-bold">Limited Intake Only:</strong> Seats are limited to maintain quality and a cohort serious about supply chain as a strategic career discipline.
          </p>
          <div>
            ...
            <ul className="space-y-3 text-booth-dark-gray font-trade-gothic-light">
              ...
              <li className="flex items-center gap-3">
                <span className="text-booth-maroon mt-1">•</span>
                <span>
                  <strong>Personal Statement:</strong> Clear interest in operations,
