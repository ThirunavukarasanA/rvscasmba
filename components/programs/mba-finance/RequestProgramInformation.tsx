      ...
      <div className="w-full max-w-full min-[700px]:max-w-[70%] mx-auto px-4 min-[700px]:px-6 lg:px-8 xl:px-12">
        ...
        <div className="mb-6 md:mb-12">
          <p className="text-lg md:text-xl text-booth-dark-gray font-trade-gothic-light">
            Get detailed insights about the curriculum, pedagogy, outcomes, and
        ...
        {showBrochurePopup && (
          <BrochurePopup
            courseName="MBA in Global Finance & Corporate Analyst"
            onClose={() => setShowBrochurePopup(false)}
            brochurePath="/pdfs/MBA in Global Finance & Corporate Analyst.pdf"
          />
        )}
      </div>
    </section>
