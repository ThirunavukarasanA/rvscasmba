...
const faqs = [
  {
    ...
    answer: "Yes. Scholarships are offered based on merit, entrance exam performance, alumni status, community, sports, and defence background."
  },
  {
    question: "Can multiple scholarships be combined?",
    answer: "No. Scholarships are non-cumulative; the highest applicable scholarship is awarded."
  }
];
