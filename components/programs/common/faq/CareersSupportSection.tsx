...
const faqs = [
  {
    ...
    answer: "Students receive structured placement training, skill development programs, resume support, mock interviews, and industry networking opportunities."
  },
  {
    question: "Are placements guaranteed?",
    answer: "Placements are supported through institutional training and industry partnerships. Outcomes depend on individual performance and market conditions."
  }
];
