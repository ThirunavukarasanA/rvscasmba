...
const faqs = [
  {
    ...
    answer: "The learning model emphasizes applied learning through case studies, projects, simulations, internships, and continuous assessment."
  },
  {
    question: "Does the program include internships or practical exposure?",
    answer: "Yes. Industry exposure is integrated through internships, live projects, and industry interactions."
  }
];
