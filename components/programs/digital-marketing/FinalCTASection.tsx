      ...
      <div className="w-full max-w-full min-[700px]:max-w-[70%] mx-auto px-4 min-[700px]:px-6 lg:px-8 xl:px-12">
        <div className="mb-6 md:mb-12">
          ...
          <h2 className="text-3xl md:text-5xl font-trade-gothic-bold text-white mb-4">
            Build Marketing Capability That Works in the Real World.
          </h2>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <Link
            href="https://admissions.rvscas.ac.in?id=624695a374b78f49cd6c2bc6&leadform=RVSCAS_MBA_Website_Digital_Marketing_Build_Marketing_CTA_Section"
